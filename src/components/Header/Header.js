...
function Header() {
    return (
        <div>
            ...
            <Navbar.Brand as={Link} to="/" style={{fontSize: "xx-large", marginLeft: "100px"}}><strong style={{fontWeight:"900"}} >Books</strong>Reviews</Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="container-fluid">
                <Nav.Link className="ml-auto Nav_link"  to="/" exact as={Link}>HOME</Nav.Link>
